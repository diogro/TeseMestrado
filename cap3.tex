...
informação. 
Após cerca de $1000$ gerações o sistema se encontra em equilíbrio
...
A medida que aumentamos a intensidade de seleção os módulos se tornam
...
\end{figure}
   ...
   \begin{figure}[htbp]
      ...
      \caption{ AVG-Ratio e modularidade $L$ para corridas com
         $\mu/\mu_B = 5$, $Ne = 2500$, $m/p=2$, sofrendo seleção
...
(período suficiente para o surgimento de módulos), seguidas de 5000
...
\begin{figure}[htbp]
  ...
  mudança correlacionada dentro dos módulos durante as 5000
